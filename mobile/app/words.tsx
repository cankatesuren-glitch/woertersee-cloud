...
export default function WordsScreen() {
  ...
  async function add() {
    ...
    try {
      ...
      setGerman(""); setEnglish(""); setCategory(""); setNotice("Word added to your collection.");
    } catch (e) { setError(messageFor(e)); }
  ...
  return <SafeAreaView style={s.safe}>
    <ScrollView contentContainerStyle={s.page} keyboardShouldPersistTaps="handled" refreshControl={<RefreshControl refreshing={loading} onRefresh={load} />}>
      ...
      <View style={s.form}>
        ...
        <Field label="Category (optional)" value={category} change={setCategory} placeholder="Travel, Work, Verbs…" />
